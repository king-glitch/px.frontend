...
import { LuCreditCard, LuLayers } from "react-icons/lu";
...
export interface SpendByAccountChartProps {
	from?: string;
	to?: string;
}

export const SpendByAccountChart: React.FC<SpendByAccountChartProps> = ({
	from,
	to,
}) => {
	...
	return (
		...
		>
			<HStack gap={2} mb={4}>
				<Icon as={LuCreditCard} color="mint.fg" />
			...
			{isLoading ? (
				...
				<VStack py={10} textAlign="center" color="fg.muted" gap={2}>
					...
					<Text fontSize="sm">No account spend recorded for this period.</Text>
				</VStack>
			) : (
...
export default SpendByAccountChart;
